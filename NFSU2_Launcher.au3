...
#AutoIt3Wrapper_Icon=NFSU2_icon.ico
#AutoIt3Wrapper_Outfile=NFSU2_Launcher.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_UseUpx=n
#AutoIt3Wrapper_UPX_Parameters=-9 --strip-relocs=0 --compress-exports=0 --compress-icons=0
#AutoIt3Wrapper_Res_Description=Need for Speed™ Underground 2 Widescreen Launcher
...
#pragma compile(FileDescription, 'Need for Speed™ Underground 2 Widescreen Launcher')
#pragma compile(FileVersion, 1.0.0.47)
#pragma compile(InternalName, 'Need for Speed™ Underground 2 Widescreen Launcher')
#pragma compile(LegalCopyright, '2016, SalFisher47')
#pragma compile(OriginalFilename, NFSU2_Launcher.exe)
#pragma compile(ProductName, 'Need for Speed™ Underground 2 Widescreen Launcher')
#pragma compile(ProductVersion, 1.0.0.47)
#EndRegion ;**** Pragma Compile ****
; === UniCrack Installer.au3 =======================================================================================================
; Title .........: Need for Speed™ Underground 2 Launcher
; Version .......: 1.0.0.47
; AutoIt Version : 3.3.14.5
; Language ......: English
; Description ...: Need for Speed™ Underground 2 Widescreen Launcher
;				   - based on ThirteenAG's widescreen fix
; Author(s) .....: SalFisher47
; Last Modified .: December 26, 2016
; ==================================================================================================================================
$exe32bit = @ScriptDir & "\speed2.exe"
$widescreen_fix_ini = @ScriptDir & "\scripts\NFSUnderground2.WidescreenFix.ini"
$widescreen_fix_asi = @ScriptDir & "\scripts\NFSUnderground2.WidescreenFix.asi"
...
FileInstall("NFSU2_ProgramData.ini", @AppDataCommonDir & "\SalFisher47\WidescreenLauncher\NFSU2.ini", 0)
$cracked_ProgramData = IniRead(@AppDataCommonDir & "\SalFisher47\WidescreenLauncher\NFSU2.ini", "EXE", "cracked", 0)
#ce
If Not FileExists($exe32bit) Then
	MsgBox(16, "Need for Speed™ Underground 2 Launcher", "Executable not found:" & @CRLF & "..\speed2.exe")
	Exit
EndIf
Switch $desktopRatio
	Case 1.33   ; 4:3 aspect ratio, 1024x768
		If not FileExists($widescreen_fix_ini) Then
			...
			FileInstall("scripts\NFSUnderground2.WidescreenFix.ini", $widescreen_fix_ini, 0)
			FileInstall("scripts\NFSUnderground2.WidescreenFix.asi", $widescreen_fix_asi, 0)
			FileInstall("scripts\NFSUnderground2.WidescreenFix.dat", @ScriptDir & "\scripts\NFSUnderground2.WidescreenFix.dat", 0)
		EndIf
		;_Cracked()
